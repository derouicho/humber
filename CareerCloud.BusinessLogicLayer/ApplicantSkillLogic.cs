    ...
    public class ApplicantSkillLogic : BaseLogic<ApplicantSkillPoco>
    {
        ...
        protected override void Verify(ApplicantSkillPoco[] pocos)
        {
            ...
            foreach (var poco in pocos)
            {
                ...
                {
                    exceptions.Add(new ValidationException(101, $"Major for ApplicantSkill {poco.Id} Cannot be greater than 12."));
                }
                ...
                {
                    exceptions.Add(new ValidationException(104, $"Major for ApplicantSkill {poco.Id} Cannot be less then StartYear."));
                }
